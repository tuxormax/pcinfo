...
class DiskInfoPanel(QWidget):
    ...
    def _build_ui(self):
        ...
        self._copy_disk_btn = QPushButton("  📋  Copiar resumen  ")
        self._copy_disk_btn.clicked.connect(self._copy_disk_to_clipboard)
        self._copy_disk_btn.setEnabled(False)
        model_l.addWidget(self._copy_disk_btn)
        ...
        left_fields = [
            ("Firmware",           "firmware"),
            ("Interfaz",           "interface"),
            ("Modo Transferencia", "transfer_mode"),
            ("Estándar",           "standard"),
            ("Unidad",             "mountpoint"),
            ("Capacidad",          "capacity"),
        ...
        right_fields = [
            ("Escrituras Totales",     "total_writes"),
            ("Velocidad de Rotación",  "rotation_rate"),
        ...
        self.table.setHorizontalHeaderLabels([
            "ID", "Nombre del Atributo", "Estado", "Valor", "Peor", "Umbral", "Valor Raw"
        ])
...
class SystemInfoPanel(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self._copy_btn = QPushButton("  📋  Copiar info  ")
        self._copy_btn.clicked.connect(self._copy_to_clipboard)
        self._copy_btn.setEnabled(False)
        hdr_l.addWidget(self._copy_btn)
