...
- [mejora-smart-drivedb](mejora-smart-drivedb.md) — ⏳ PENDIENTE (implementar después): DB por modelo estilo CDI para unidades/vida SMART. Hoy solo override puntual ADATA SU.
